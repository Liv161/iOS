 ...
 */
let firstname:String = "Livio"
let lastname:String = "De La Cruz"
...
let newBest = 15125
let congratulations:String = ("Congratulations, \(fullname)! You beat your previous daily high score of \(String(previousBest)) steps by walking \(String(newBest)) steps yesterday!")
