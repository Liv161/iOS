...
let avgerageHR = addedHR / 3
print("Average Heart Rate:", avgerageHR)
...
let avgerageHRD = addedHRD / 3
print("Average Heart Rate:", avgerageHRD)
...
let percentCompleted:Double = (steps / goal) * 100
