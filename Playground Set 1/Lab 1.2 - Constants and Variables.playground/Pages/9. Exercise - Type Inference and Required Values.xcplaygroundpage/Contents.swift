 ...
 */
var name:String
print("It does not compile because a variable can not be used before being initialized")
...
print("54.3 = distanceTraveled did not compile, you cannot assign variable to a literal value")
distanceTraveled = 54.3
print("distanceTraveled = 54.3 -->",distanceTraveled)
